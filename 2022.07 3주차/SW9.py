...
# 각 테스트 케이스마다 ‘  # x’(x는 테스트케이스 번호를 의미하며 1부터 시작한다)를 출력하고, 종민이가 내야 하는 수도 요금

T = int(input())
x = 0

# def B_company_price(R, W):
#     if (R > W):
#         pass
#     elif (R < W):
#         S
...
for i in range(1, T+1):
    ...
    print(f'#{i} {min(A_company,B_company)}')
...
# B사의 기본 요금 Q
#  B사의 월간 사용량 R
#  B사의 R량보다 클시 추가되는 금액 S
#  종민이의 한 달간 사용하는 수도양 W
