...
console.log(toArray2("Neo", "Shinji"), toArray2({
    x: 1
}, {
    x: 2
}), toArray2([
...
const emahki5 = new User11({
    name: "emhaki",
    age: 20,
    isValid: true
});
const neo2 = new User11({
    name: "neo",
    age: 20,
    emails: [
        "emhaki@gmail.com",
...
console.log((0, _lodashDefault.default).camelCase(str2));
console.log((0, _lodashDefault.default).snakeCase(str2));
console.log((0, _lodashDefault.default).kebabCase(str2));
...
},{}]},["cnpQZ","jeorp"], "jeorp", "parcelRequirec115")
